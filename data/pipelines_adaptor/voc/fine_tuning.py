...
class FineTuneFSODAdaptor:
    def __init__(self, novel_id=0, num_shots=5,
        ...
        assert(self.num_shots in [1, 2, 3, 5, 10])
        ...
        self.data_options['meta'] = \
            self.data_options['meta'].replace('5shot', '{}shot'.format(self.num_shots))
...
if __name__ == "__main__":
    base_pipe_instance = FineTuneFSODAdaptor(novel_id=1, num_shots=11)