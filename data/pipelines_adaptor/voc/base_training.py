...
class BaseTrainFSODAdaptor:
    def __init__(self, novel_id=0,
                 path_config='config_base_training.yaml',
...
if __name__ == "__main__":
    base_pipe_instance = BaseTrainFSODAdaptor(novel_id=2)